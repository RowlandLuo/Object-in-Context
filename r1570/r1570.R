rm(list = ls())
library(tidyverse)
SimilarLearn <- read_csv("240711_r1570_0_baseline_learn.csv")
SimilarLearn <- SimilarLearn %>%
  select(!15:24) %>%
  filter(Value.Item1.Item2>21) %>%
...
p1
library(ggforce)
p1circle <- p1 + geom_circle(aes(x0 = 309, y0 = 715, r = 130), color = "blue")
p1circle <- p1circle + geom_circle(aes(x0 = 797, y0 = 261, r = 130), color = "blue")
p1circle <- p1circle +
  ggtitle("baseline")
p1circle
radius <- 130
...
BaselineLearn <- read_csv("240711_r1570_1_similar_learn.csv")
BaselineLearn <- BaselineLearn %>%
  select(!15:24) %>%
  filter(Value.Item1.Item2>35) %>%
  rename(pixelx = Value.Item1.Item3.X, pixely = Value.Item1.Item3.Y, TimePoint = Value.Item1.Item2) %>%
  select(!1, !14)
...
p2 <- ggplot(df2, aes(x = x2, y = y2)) +
  geom_point(alpha = 0.3)
p2
p2circle <- p2 + geom_circle(aes(x0 = 324, y0 = 710, r = 130), color = "red")
p2circle <- p2circle + geom_circle(aes(x0 = 788, y0 = 266, r = 130), color = "red")
p2circle <- p2circle +
  ggtitle("similar")
p2circle
radius <- 130
...
BaselineTest <- read_csv("240711_r1570_2_similar_test.csv")
BaselineTest <- BaselineTest %>%
  select(!15:24) %>%
  filter(Value.Item1.Item2>45) %>%
  rename(pixelx = Value.Item1.Item3.X, pixely = Value.Item1.Item3.Y, TimePoint = Value.Item1.Item2) %>%
  select(!1, !14)
...
p3circle <- p3circle + geom_circle(aes(x0 = 788, y0 = 251, r = 130), color = "blue")
p3circle <- p3circle +
  ggtitle("similar")
p3circle
radius <- 130
...
p4 <- ggplot(df4, aes(x = x4, y = y4)) +
  geom_point(alpha = 0.3)
p4
p4circle <- p4 + geom_circle(aes(x0 = 462, y0 = 989, r = 130), color = "green")
p4circle <- p4circle + geom_circle(aes(x0 = 1040, y0 = 452, r = 130), color = "green")
p4circle <- p4circle +
  ggtitle("different")
p4circle
radius <- 130
...
DifferentLearn <- read_csv("240711_r1570_4_baseline_learn.csv")
...
p5 <- ggplot(df5, aes(x = x5, y = y5)) +
  geom_point(alpha = 0.3)
p5
p5circle <- p5 + geom_circle(aes(x0 = 299, y0 = 690, r = 130), color = "purple")
p5circle <- p5circle + geom_circle(aes(x0 = 808, y0 = 251, r = 130), color = "purple")
p5circle <- p5circle +
  ggtitle("baseline")
p5circle
radius <- 130
...
DifferentTest <- read_csv("240711_r1570_5_different_test.csv")
DifferentTest <- DifferentTest %>%
  select(!15:24) %>%
  filter(Value.Item1.Item2>51) %>%
  rename(pixelx = Value.Item1.Item3.X, pixely = Value.Item1.Item3.Y, TimePoint = Value.Item1.Item2) %>%
  select(!1, !14)
...
p6 <- ggplot(df6, aes(x = x6, y = y6)) +
  geom_point(alpha = 0.3)
p6
p6circle <- p6 + geom_circle(aes(x0 = 457, y0 = 989, r = 130), color = "green")
p6circle <- p6circle + geom_circle(aes(x0 = 1035, y0 = 452, r = 130), color = "purple")
p6circle <- p6circle +
  ggtitle("different")
p6circle
radius <- 130
