rm(list = ls())
library(tidyverse)
SimilarLearn <- read_csv("240711_r1573_0_similar_learn.csv")
SimilarLearn <- SimilarLearn %>%
  select(!15:24) %>%
  filter(Value.Item1.Item2>46) %>%
...
p1
library(ggforce)
p1circle <- p1 + geom_circle(aes(x0 = 309, y0 = 735, r = 130), color = "blue")
p1circle <- p1circle + geom_circle(aes(x0 = 787, y0 = 251, r = 130), color = "blue")
p1circle <- p1circle +
  ggtitle("similar")
p1circle
radius <- 130
...
BaselineLearn <- read_csv("240711_r1573_1_baseline_learn.csv")
...
p2 <- ggplot(df2, aes(x = x2, y = y2)) +
  geom_point(alpha = 0.3)
p2
p2circle <- p2 + geom_circle(aes(x0 = 304, y0 = 710, r = 130), color = "red")
p2circle <- p2circle + geom_circle(aes(x0 = 798, y0 = 251, r = 130), color = "red")
p2circle <- p2circle +
  ggtitle("baseline")
p2circle
radius <- 130
...
BaselineTest <- read_csv("240711_r1573_2_similar_test.csv")
BaselineTest <- BaselineTest %>%
  select(!15:24) %>%
  filter(Value.Item1.Item2>31) %>%
  rename(pixelx = Value.Item1.Item3.X, pixely = Value.Item1.Item3.Y, TimePoint = Value.Item1.Item2) %>%
  select(!1, !14)
...
p3 <- ggplot(df3, aes(x = x3, y = y3)) +
  geom_point(alpha = 0.3)
p3
p3circle <- p3 + geom_circle(aes(x0 = 309, y0 = 715, r = 130), color = "blue")
p3circle <- p3circle + geom_circle(aes(x0 = 788, y0 = 246, r = 130), color = "red")
p3circle <- p3circle +
  ggtitle("similar")
p3circle
radius <- 130
...
BaselineLearn1 <- read_csv("240711_r1573_3_baseline_learn.csv")
...
p4 <- ggplot(df4, aes(x = x4, y = y4)) +
  geom_point(alpha = 0.3)
p4
p4circle <- p4 + geom_circle(aes(x0 = 309, y0 = 710, r = 130), color = "green")
p4circle <- p4circle + geom_circle(aes(x0 = 793, y0 = 246, r = 130), color = "green")
p4circle <- p4circle +
  ggtitle("baseline")
p4circle
radius <- 130
...
DifferentLearn <- read_csv("240711_r1573_4_different_learn.csv")
DifferentLearn <- DifferentLearn %>%
  select(!15:24) %>%
  filter(Value.Item1.Item2>30) %>%
  rename(pixelx = Value.Item1.Item3.X, pixely = Value.Item1.Item3.Y, TimePoint = Value.Item1.Item2) %>%
  select(!1, !14)
...
p5 <- ggplot(df5, aes(x = x5, y = y5)) +
  geom_point(alpha = 0.3)
p5
p5circle <- p5 + geom_circle(aes(x0 = 462, y0 = 984, r = 130), color = "purple")
p5circle <- p5circle + geom_circle(aes(x0 = 1040, y0 = 452, r = 130), color = "purple")
p5circle <- p5circle +
  ggtitle("different")
p5circle
radius <- 130
...
DifferentTest <- read_csv("240711_r1573_5_baseline_test.csv")
DifferentTest <- DifferentTest %>%
  select(!15:24) %>%
  filter(Value.Item1.Item2>34) %>%
  rename(pixelx = Value.Item1.Item3.X, pixely = Value.Item1.Item3.Y, TimePoint = Value.Item1.Item2) %>%
  select(!1, !14)
...
p6 <- ggplot(df6, aes(x = x6, y = y6)) +
  geom_point(alpha = 0.3)
p6
p6circle <- p6 + geom_circle(aes(x0 = 299, y0 = 690, r = 130), color = "green")
p6circle <- p6circle + geom_circle(aes(x0 = 808, y0 = 251, r = 130), color = "purple")
p6circle <- p6circle +
  ggtitle("baseline")
p6circle
radius <- 130
