rm(list = ls())
library(tidyverse)
SimilarLearn <- read_csv("240816_r1558_0_baseline_learn.csv")
SimilarLearn <- SimilarLearn %>%
  select(!15:24) %>%
  filter(Value.Item1.Item1.Item2>113) %>%
...
p1circle <- p1 + geom_circle(aes(x0 = 391, y0 = 160, r = 70), color = "purple")
p1circle <- p1circle + geom_circle(aes(x0 = 130, y0 = 393, r = 70), color = "purple")
p1circle
radius <- 70
center_x1 <- 391
center_y1 <- 160
...
BaselineLearn <- read_csv("240816_r1558_different_1.csv")
BaselineLearn <- BaselineLearn %>%
  select(!15:24) %>%
  filter(Value.Item1.Item1.Item2>152) %>%
  rename(pixelx = Value.Item1.Item1.Item3.X, pixely = Value.Item1.Item1.Item3.Y, TimePoint = Value.Item1.Item1.Item2) %>%
  select(!1, !14) %>%
  na.omit
Baselinelearn <- BaselineLearn %>%
...
p2 <- ggplot(df2, aes(x = x2, y = y2)) +
  geom_point(alpha = 0.3)
p2
p2circle <- p2 + geom_circle(aes(x0 = 497, y0 = 258, r = 75), color = "green")
p2circle <- p2circle + geom_circle(aes(x0 = 220, y0 = 483, r = 75), color = "green")
p2circle
radius <- 75
center_x1 <- 497
center_y1 <- 258
...
SimilarTest <- read_csv("240816_r1558_different_2.csv")
SimilarTest <- SimilarTest %>%
  select(!15:24) %>%
  filter(Value.Item1.Item1.Item2>176) %>%
  rename(pixelx = Value.Item1.Item1.Item3.X, pixely = Value.Item1.Item1.Item3.Y, TimePoint = Value.Item1.Item1.Item2) %>%
  select(!1, !14) %>%
  na.omit
SimilarTest <- SimilarTest %>%
...
p3 <- ggplot(df3, aes(x = x3, y = y3)) +
  geom_point(alpha = 0.3)
p3
p3circle <- p3 + geom_circle(aes(x0 = 502, y0 = 258, r = 80), color = "green")
p3circle <- p3circle + geom_circle(aes(x0 = 210, y0 = 483, r = 80), color = "purple") +
  ggtitle("baseline")
p3circle
radius <- 80
center_x3 <- 502
...
DifferentLearn <- read_csv("240816_r1558_3_baseline_learn.csv")
DifferentLearn <- DifferentLearn %>%
  select(!15:24) %>%
  filter(Value.Item1.Item1.Item2>66) %>%
  rename(pixelx = Value.Item1.Item1.Item3.X, pixely = Value.Item1.Item1.Item3.Y, TimePoint = Value.Item1.Item1.Item2) %>%
  select(!1, !14) %>%
  na.omit
DifferentLearn <- DifferentLearn %>%
...
p4 <- ggplot(df4, aes(x = x4, y = y4)) +
  geom_point(alpha = 0.3)
p4
p4circle <- p4 + geom_circle(aes(x0 = 391, y0 = 165, r = 80), color = "blue")
p4circle <- p4circle + geom_circle(aes(x0 = 130, y0 = 378, r = 80), color = "blue")
p4circle
radius <- 80
center_x4 <- 391
center_y4 <- 165
...
BaselineLearn1 <- read_csv("240816_r1558_4_similar_learn.csv")
BaselineLearn1 <- BaselineLearn1 %>%
  select(!15:24) %>%
  filter(Value.Item1.Item1.Item2>119) %>%
  rename(pixelx = Value.Item1.Item1.Item3.X, pixely = Value.Item1.Item1.Item3.Y, TimePoint = Value.Item1.Item1.Item2) %>%
  select(!1, !14) %>%
  na.omit %>%
  filter(!Value.Item2 == TRUE)
...
p5 <- ggplot(df5, aes(x = x5, y = y5)) +
  geom_point(alpha = 0.3)
p5
p5circle <- p5 + geom_circle(aes(x0 = 391, y0 = 165, r = 70), color = "red")
p5circle <- p5circle + geom_circle(aes(x0 = 130, y0 = 388, r = 70), color = "red")
p5circle
radius <- 70
center_x5 <- 391
center_y5 <- 165
...
DifferentTest <- read_csv("240816_r1558_5_similar_test.csv")
DifferentTest <- DifferentTest %>%
  select(!15:24) %>%
  filter(Value.Item1.Item1.Item2>76) %>%
  rename(pixelx = Value.Item1.Item1.Item3.X, pixely = Value.Item1.Item1.Item3.Y, TimePoint = Value.Item1.Item1.Item2) %>%
  select(!1, !14) %>%
  filter(!Value.Item2 == TRUE) %>%
  na.omit
...
p6 <- ggplot(df6, aes(x = x6, y = y6)) +
  geom_point(alpha = 0.3)
p6
p6circle <- p6 + geom_circle(aes(x0 = 381, y0 = 175, r = 80), color = "red")
p6circle <- p6circle + geom_circle(aes(x0 = 130, y0 = 393, r = 80), color = "blue")
p6circle
radius <- 80
center_x6 <- 381
center_y6 <- 175
