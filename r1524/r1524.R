rm(list = ls())
library(tidyverse)
SimilarLearn <- read_csv("240726_r1524_0_baseline_learn.csv")
SimilarLearn <- SimilarLearn %>%
  select(!15:24) %>%
  filter(Value.Item1.Item1.Item2>15) %>%
...
p1circle <- p1 + geom_circle(aes(x0 = 381, y0 = 173, r = 75), color = "blue")
p1circle <- p1circle + geom_circle(aes(x0 = 130, y0 = 393, r = 75), color = "blue")
p1circle
radius <- 75
center_x1 <- 381
center_y1 <- 173
...
BaselineLearn <- read_csv("240726_r1524_1_similar_learn.csv")
BaselineLearn <- BaselineLearn %>%
  select(!15:24) %>%
  filter(Value.Item1.Item1.Item2>339) %>%
  rename(pixelx = Value.Item1.Item1.Item3.X, pixely = Value.Item1.Item1.Item3.Y, TimePoint = Value.Item1.Item1.Item2) %>%
  select(!1, !14) %>%
  na.omit
Baselinelearn <- BaselineLearn %>%
...
p2 <- ggplot(df2, aes(x = x2, y = y2)) +
  geom_point(alpha = 0.3)
p2
p2circle <- p2 + geom_circle(aes(x0 = 381, y0 = 173, r = 75), color = "red")
p2circle <- p2circle + geom_circle(aes(x0 = 130, y0 = 393, r = 75), color = "red")
p2circle
radius <- 75
center_x1 <- 381
center_y1 <- 173
...
SimilarTest <- read_csv("240726_r1524_2_similar_test.csv")
...
DifferentLearn <- read_csv("240726_r1524_3_baseline_learn.csv")
DifferentLearn <- DifferentLearn %>%
  select(!15:24) %>%
  filter(Value.Item1.Item1.Item2>93) %>%
  rename(pixelx = Value.Item1.Item1.Item3.X, pixely = Value.Item1.Item1.Item3.Y, TimePoint = Value.Item1.Item1.Item2) %>%
  select(!1, !14) %>%
  na.omit
DifferentLearn <- DifferentLearn %>%
...
p4 <- ggplot(df4, aes(x = x4, y = y4)) +
  geom_point(alpha = 0.3)
p4
p4circle <- p4 + geom_circle(aes(x0 = 381, y0 = 165, r = 75), color = "purple")
p4circle <- p4circle + geom_circle(aes(x0 = 130, y0 = 393, r = 75), color = "purple")
p4circle
radius <- 75
center_x4 <- 381
center_y4 <- 165
...
BaselineLearn1 <- read_csv("240726_r1524_different_4.csv")
BaselineLearn1 <- BaselineLearn1 %>%
  select(!15:24) %>%
  filter(Value.Item1.Item1.Item2>260) %>%
  rename(pixelx = Value.Item1.Item1.Item3.X, pixely = Value.Item1.Item1.Item3.Y, TimePoint = Value.Item1.Item1.Item2) %>%
  select(!1, !14) %>%
  na.omit %>%
  filter(!Value.Item2 == TRUE)
...
p5 <- ggplot(df5, aes(x = x5, y = y5)) +
  geom_point(alpha = 0.3)
p5
p5circle <- p5 + geom_circle(aes(x0 = 502, y0 = 253, r = 75), color = "green")
p5circle <- p5circle + geom_circle(aes(x0 = 220, y0 = 473, r = 75), color = "green")
p5circle
radius <- 75
center_x5 <- 502
center_y5 <- 253
...
DifferentTest <- read_csv("240726_r1524_5_baseline_test.csv")
DifferentTest <- DifferentTest %>%
  select(!15:24) %>%
  filter(Value.Item1.Item1.Item2>221) %>%
  rename(pixelx = Value.Item1.Item1.Item3.X, pixely = Value.Item1.Item1.Item3.Y, TimePoint = Value.Item1.Item1.Item2) %>%
  select(!1, !14) %>%
  filter(!Value.Item2 == TRUE) %>%
  na.omit
...
p6 <- ggplot(df6, aes(x = x6, y = y6)) +
  geom_point(alpha = 0.3)
p6
p6circle <- p6 + geom_circle(aes(x0 = 381, y0 = 173, r = 75), color = "purple")
p6circle <- p6circle + geom_circle(aes(x0 = 130, y0 = 393, r = 75), color = "green")
p6circle
radius <- 75
center_x6 <- 381
center_y6 <- 173
