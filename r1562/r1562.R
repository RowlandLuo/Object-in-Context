rm(list = ls())
library(tidyverse)
SimilarLearn <- read_csv("240816_r1562_0_baseline_learn.csv")
SimilarLearn <- SimilarLearn %>%
  select(!15:24) %>%
  filter(Value.Item1.Item1.Item2>114) %>%
...
p1circle <- p1 + geom_circle(aes(x0 = 386, y0 = 165, r = 75), color = "green")
p1circle <- p1circle + geom_circle(aes(x0 = 140, y0 = 393, r = 75), color = "green")
p1circle
radius <- 75
center_x1 <- 386
center_y1 <- 165
...
BaselineLearn <- read_csv("240816_r1562_different_1.csv")
BaselineLearn <- BaselineLearn %>%
  select(!15:24) %>%
  filter(Value.Item1.Item1.Item2>236) %>%
  rename(pixelx = Value.Item1.Item1.Item3.X, pixely = Value.Item1.Item1.Item3.Y, TimePoint = Value.Item1.Item1.Item2) %>%
  select(!1, !14) %>%
  na.omit
Baselinelearn <- BaselineLearn %>%
...
p2 <- ggplot(df2, aes(x = x2, y = y2)) +
  geom_point(alpha = 0.3)
p2
p2circle <- p2 + geom_circle(aes(x0 = 507, y0 = 253, r = 80), color = "purple")
p2circle <- p2circle + geom_circle(aes(x0 = 215, y0 = 478, r = 80), color = "purple")
p2circle
radius <- 80
center_x1 <- 507
center_y1 <- 253
...
SimilarTest <- read_csv("240816_r1562_2_baseline_test.csv")
SimilarTest <- SimilarTest %>%
  select(!15:24) %>%
  filter(Value.Item1.Item1.Item2>147) %>%
  rename(pixelx = Value.Item1.Item1.Item3.X, pixely = Value.Item1.Item1.Item3.Y, TimePoint = Value.Item1.Item1.Item2) %>%
  select(!1, !14) %>%
  na.omit
SimilarTest <- SimilarTest %>%
...
p3 <- ggplot(df3, aes(x = x3, y = y3)) +
  geom_point(alpha = 0.3)
p3
p3circle <- p3 + geom_circle(aes(x0 = 391, y0 = 165, r = 75), color = "green")
p3circle <- p3circle + geom_circle(aes(x0 = 130, y0 = 393, r = 75), color = "purple") +
  ggtitle("baseline")
p3circle
radius <- 75
center_x3 <- 391
...
DifferentLearn <- read_csv("240816_r1562_3_baseline_learn.csv")
DifferentLearn <- DifferentLearn %>%
  select(!15:24) %>%
  filter(Value.Item1.Item1.Item2>110) %>%
  rename(pixelx = Value.Item1.Item1.Item3.X, pixely = Value.Item1.Item1.Item3.Y, TimePoint = Value.Item1.Item1.Item2) %>%
  select(!1, !14) %>%
  na.omit
DifferentLearn <- DifferentLearn %>%
...
p4 <- ggplot(df4, aes(x = x4, y = y4)) +
  geom_point(alpha = 0.3)
p4
p4circle <- p4 + geom_circle(aes(x0 = 381, y0 = 155, r = 80), color = "red")
p4circle <- p4circle + geom_circle(aes(x0 = 130, y0 = 393, r = 75), color = "red")
p4circle
radius <- 75
center_x4 <- 381
center_y4 <- 155
...
BaselineLearn1 <- read_csv("240816_r1562_4_similar_learn.csv")
BaselineLearn1 <- BaselineLearn1 %>%
  select(!15:24) %>%
  filter(Value.Item1.Item1.Item2>83) %>%
  rename(pixelx = Value.Item1.Item1.Item3.X, pixely = Value.Item1.Item1.Item3.Y, TimePoint = Value.Item1.Item1.Item2) %>%
  select(!1, !14) %>%
  na.omit %>%
  filter(!Value.Item2 == TRUE)
...
p5 <- ggplot(df5, aes(x = x5, y = y5)) +
  geom_point(alpha = 0.3)
p5
p5circle <- p5 + geom_circle(aes(x0 = 401, y0 = 165, r = 80), color = "blue")
p5circle <- p5circle + geom_circle(aes(x0 = 125, y0 = 393, r = 80), color = "blue")
p5circle
radius <- 80
center_x5 <- 401
center_y5 <- 165
...
DifferentTest <- read_csv("240816_r1562_5_baseline_test.csv")
DifferentTest <- DifferentTest %>%
  select(!15:24) %>%
  filter(Value.Item1.Item1.Item2>111) %>%
  rename(pixelx = Value.Item1.Item1.Item3.X, pixely = Value.Item1.Item1.Item3.Y, TimePoint = Value.Item1.Item1.Item2) %>%
  select(!1, !14) %>%
  filter(!Value.Item2 == TRUE) %>%
  na.omit
...
p6 <- ggplot(df6, aes(x = x6, y = y6)) +
  geom_point(alpha = 0.3)
p6
p6circle <- p6 + geom_circle(aes(x0 = 386, y0 = 160, r = 75), color = "red")
p6circle <- p6circle + geom_circle(aes(x0 = 125, y0 = 393, r = 75), color = "blue")
p6circle
radius <- 75
center_x6 <- 386
center_y6 <- 160
